...
//        SipstisScreen.AlertManagement.name -> SipstisScreen.CreateAlert.name
//        SipstisScreen.Home.name -> SipstisScreen.CreateReport.name
//        else -> ""
//    }
    ...
    Column(
        ...
        if (user.roles.contains("ROLE_ADMIN")) {
            DrawerNavigationItem(
                ...
                text = R.string.role_admin
            ) {
                navController.navigate(SipstisScreen.Admin.name)
                closeDrawer()
            }
        }
